  ...
  fetch('graduatoria.tsv')
    ...
    .then(data => {
      ...
      if (posizione <= 2000) {
        ...
        const posizioneDopoDuemila = Math.abs(posizione - 2000) * 0.5;
      ...
      document.getElementById('result').innerHTML = `La posizione stimata per il 10 Ottobre è ${Math.round(posizioneFinale)}`;
